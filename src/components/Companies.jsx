  ...
  return (
    <section aria-label="Trusted Partners" className="border-y border-slate-100 dark:border-white/5 bg-slate-50/50 dark:bg-slate-card/10 py-10 transition-colors duration-300">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mt-8 grid grid-cols-2 items-center justify-items-center gap-x-8 gap-y-10 sm:grid-cols-3 md:grid-cols-5 lg:gap-x-12 opacity-50 dark:opacity-40 grayscale contrast-200">
          {/* Logo 1 */}
          <div className="flex items-center gap-2 text-slate-900 dark:text-white font-display font-semibold tracking-tight text-lg">
